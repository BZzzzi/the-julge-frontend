...
function Footer() {
  return (
    <div className="bg-gray-10">
      <div className="mx-auto flex h-31.5 max-w-83.75 flex-col-reverse items-start justify-start gap-7.5 pb-4 text-gray-50 md:max-w-170 md:flex-row md:items-center md:justify-between md:p-0 lg:max-w-241">
        <Link
